...
public class LDAP {
    ...
    public int validarIngresoLDAPRestringido(String user, String pass,String grupo) { //SC_Transferencias
        ...
        try {
            ...
            if (memberOf != null) {
                for (Enumeration e1 = memberOf.getAll(); e1.hasMoreElements();) {
                    ...
                    if (isSame(groupCN, unprocessedGroupCN) && isSame(groupDistinguishedName, unprocessedGroupDN)) {                        
                        System.out.println(user+ " authorized generación gaceta patentes");
                        return 1;
                    } else {
            ...
            System.out.println(user+ " not authorized generación gaceta patentes");

            return -1;
        } catch (Exception ex) {
            System.out.println("Credenciales incorrectas generación gaceta patentes: " + user);
            return 0;
        }
    }
    ...
    public void validarConexion() {
        try {
            ...
            System.out.println("Error validando conexion ldap generación gaceta patentes: " + ex);
        }
    }
